...
`;
// 우리거ㅏ 만든 Button컴포넌트는 Button태그처럼 사용할 거야.
// 그러니까 버튼 태그가 받을 수 있는 속성을 다 허용해줘 => 상속을 이용 (interface)
// Button태그의 타입 :  ButtonHTMLAttributes<HTMLButtonElement>

//즉, 우리가 만든 Button 컴포포넌트는 button의 확장판이다.
