...
export const AdminTd = styled.td`
    // td는 flex를 쓸 수 없음 => 그 안에 들어가는 요소에 대한 정렬은 text-align솨 vertical-align을 통해 해야 함
    padding: 16px;
    font-size: 14px;
...
// 매 번 props에 대한 함수를 props => 로 써 줬던 것은
// 그렇게 만드는 함수의 매개변수가 1개이기 때문에 소괄호가 생략된 것임
// 그렇게 들아오는 props.$align의 기본값을 설정해주기 위해서는
// 소괄호를 생략하지 않고 써야 함.
// 구조분해할당을 통해 다음과 같이 써 줘야함.
